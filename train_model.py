...
def create_model():
    ...
    model = Sequential([
        ...
        Dropout(0.5),
        Dense(3, activation='softmax') # 3 categories: sad, happy, surprised
    ])
...
model.save('facial_expression_model.h5') # save the model
print("Model training complete. Model saved as 'facial_expression_model.h5'.")